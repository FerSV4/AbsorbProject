...
import classes from './TextField_StateDefaultSerial12.module.css';
...
/* @figmaId 2557:4560 */
export const TextField_StateDefaultSerial12: FC<Props> = memo(function TextField_StateDefaultSerial12(props = {}) {
  return (
