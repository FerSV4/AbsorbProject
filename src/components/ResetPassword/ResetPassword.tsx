  ...
  return (
    <div className={`${resets.clapyResets} ${classes.root}`}>
      ...
      <div className={classes.lOGIN}>
        ...
        <div className={classes.provideTheEmailAssociatedWithY}>
        ...
        <div className={classes.buttonGroup}>
          <button className={classes.button3}>
            <div className={classes.sendPasswordResetLink}>Send password reset link</div>
          </button>
        </div>
      ...
      <div className={classes.header}>
        ...
        <TextField_StateDefaultSerial1
          ...
          text={{
            placeholder: <div className={classes.placeholder2}>Buy instruments at competitive prices... </div>,
          }}
        />
        <IconButton_VariantPrimaryState
